...
//
//       case 'bulk':
//         return 'SAVE ${offer['discountPercent']}% on ${offer['minQty']}+';
//
//       default:
//         return '';
//     }
...
//     final offer = item.offer;
//     if (offer == null) return item.price;
//
//     if (offer['type'] == 'percentage') {
//       return item.price * (1 - offer['value'] / 100);
//     }
//
//     return item.price; // others handled in cart
//   }
//
//   @override
//   void initState() {
...
//         itemBuilder: (_, i) => _PrevCard(item: items[i], activeDiscounts: activeDiscounts),
//       ),
//     );
//   }
// }
...
//     final discount = DiscountEngine().bestDiscount(item, activeDiscounts);
//
//     return Container(
//       width: 140,
...
//           itemBuilder: (_, i) => _ItemCard(item: items[i], activeDiscounts: activeDiscounts),
//         ),
//       ),
//     );
//   }
...
//   @override
//   Widget build(BuildContext context) {
//     final discount = DiscountEngine().bestDiscount(widget.item, widget.activeDiscounts);
//     final mrp = widget.item.price.toStringAsFixed(0);
//     return GestureDetector(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ── PREVIOUSLY BOUGHT ────────────────────
                      _SectionHeader(title: 'Previously Bought',
                      ...
                      itemsAsync.when(
                          ...
                          error: (e, _) => _ErrorTile(
                              ...
                              onRetry: _refresh),
                          data: (_) {
                            // Show only 6 items, click "See All" to view more
